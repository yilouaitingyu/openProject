define(['crossAPI','Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/oneTroubleTicket.html', 'style!css/workflow/oneservicecompain/basicMessage.css'],
function(CrossAPI,Util, Timer, Validator, Select, SelectTree, Mydate, IndexLoad, DetailPanel, Hdb, Html_basicMessage) {
    ...
    $.extend(initialize.prototype, {
        ...
        dictionaryInit: function() {
        	this.loadDictionary('staticDictionary_get', '', 'wholeNetwork'); //全网/本地
