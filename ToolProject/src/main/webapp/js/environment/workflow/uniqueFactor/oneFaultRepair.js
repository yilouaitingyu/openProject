define(['crossAPI','Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/oneFaultRepair.html', 'style!css/workflow/oneservicecompain/basicMessage.css'],
function(CrossAPI,Util, Timer, Validator, Select, SelectTree, Mydate, IndexLoad, DetailPanel, Hdb, Html_basicMessage) {
    ...
    $.extend(initialize.prototype, {
        ...
        dictionaryInit: function() {
            ...
            this.loadDictionary('staticDictionary_get', '', 'municipalCity'); //地市
            this.loadDictionary('staticDictionary_get', '', 'lineName'); //专线产品名称
            this.loadDictionary('staticDictionary_get', '', 'clienteleName'); //集团客户名称
            this.loadDictionary('staticDictionary_get', '', 'businessRank'); //业务保障等级
        },
        //设置省份和市区的默认字段
