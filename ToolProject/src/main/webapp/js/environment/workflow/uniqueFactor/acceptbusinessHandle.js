define(['Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/acceptbusinessHandle.html', 'style!css/workflow/oneservicecompain/basicMessage.css'],
