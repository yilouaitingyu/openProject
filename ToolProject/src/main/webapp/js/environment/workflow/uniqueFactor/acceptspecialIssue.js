define(['Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/acceptspecialIssue.html', 'style!css/workflow/oneservicecompain/basicMessage.css'],
function(Util, Timer, Validator, Select, SelectTree, Mydate, IndexLoad, DetailPanel, Hdb, Html_basicMessage) {
    ...
    $.extend(initialize.prototype, Util.eventTarget.prototype, {
        ...
        dictionaryInit: function() {
        	this.loadDictionary('staticDictionary_get', '', 'businessActi'); //业务/营销活动
