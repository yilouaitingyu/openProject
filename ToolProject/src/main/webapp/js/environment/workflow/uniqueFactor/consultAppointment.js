define(['Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/consultAppointment.html', 'style!css/workflow/oneservicecompain/consultationForm.css'],
