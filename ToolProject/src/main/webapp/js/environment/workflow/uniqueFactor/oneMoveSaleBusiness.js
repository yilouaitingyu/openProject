define(['crossAPI','Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/oneMoveSaleBusiness.html', 'style!css/workflow/oneservicecompain/basicMessage.css'],
