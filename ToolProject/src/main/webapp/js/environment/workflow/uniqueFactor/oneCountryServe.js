define(['crossAPI','Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/oneCountryServe.html', 'style!css/workflow/oneservicecompain/basicMessage.css'],
