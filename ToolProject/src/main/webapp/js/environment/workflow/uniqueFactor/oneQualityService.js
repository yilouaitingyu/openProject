define(['crossAPI','Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/oneQualityService.html', 'style!css/workflow/oneservicecompain/basicMessage.css'],
