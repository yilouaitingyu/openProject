define(['crossAPI','Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/oneMessageSafe.html', 'style!css/workflow/oneservicecompain/basicMessage.css'],
function(CrossAPI,Util, Timer, Validator, Select, SelectTree, Mydate, IndexLoad, DetailPanel, Hdb, Html_basicMessage) {
    ...
    $.extend(initialize.prototype, {
        ...
        dictionaryInit: function() {
        	this.loadDictionary('staticDictionary_get', '', 'issignBook'); //业务/营销活动
