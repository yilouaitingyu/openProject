define(['Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/consultFoundation.html', 'style!css/workflow/oneservicecompain/consultationForm.css'],
