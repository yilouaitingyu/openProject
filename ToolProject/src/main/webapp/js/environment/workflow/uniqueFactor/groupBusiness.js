define(['Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/uniqueFactor/groupBusiness.html', 'style!css/workflow/oneservicecompain/groupServiceComplain.css'],
function(Util, Timer, Validator, Select, SelectTree, Mydate, IndexLoad, DetailPanel, Hdb, Html_basicMessage) {
    ...
    $.extend(initialize.prototype, Util.eventTarget.prototype, {
        ...
        dictionaryInit: function() {
        	this.loadDictionary('staticDictionary_get', '', 'complaintScenario'); //投诉场景
            this.loadDictionary('staticDictionary_get', '', 'isbuildStation'); //是否无法建站
            this.loadDictionary('staticDictionary_get', '', 'issendAddr'); //是否发布公告
            this.loadDictionary('staticDictionary_get', '', 'gobackgoodTime'); //公告故障恢复时限
