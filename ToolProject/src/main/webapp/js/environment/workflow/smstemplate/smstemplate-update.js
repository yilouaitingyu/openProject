require(
		...
		function(MyDate, List,Select,Dialog, $,Util,IndexLoad) {
			...
			IndexLoad(function(indexModule, options) {				
				...
				$("#templateName").val(options.templateName);
            ...
            $("#save").click(function(){
          	 ...
          	 var Id = $("#Id").val();
           	 ...
           	 Util.ajax.getJson('/ngwf_he/front/sh/workflow!execute?uid=updateSmsTemplate', {Id:Id , templateName:templateName,content:content }, 
