				...
				tabs:[
				      {
				    	  ...
				    	  click:function(e, tabData){
				    		  require(['js/workflow/proposalSheet/proposalSheet'],function(BasicMessage){
				      ...
				      },
				      {
				    	  title:'流程记录',
				    	  click:function(e,tabData){
				    		  require(['js/workflow/proposalSheet/pro_flowRecord'],function(FlowRecord){
				      ...
				      },
				      {
				    	  title:'操作信息',
				    	  click:function(e, tabData){
				    		  require(['js/workflow/proposalSheet/pro_operateInfo'],function(operateInfo){
				      ...
				      },
				      {
				    	  title:'附件（0）',
				    	  click:function(e, tabData){
				    		  require(['js/workflow/proposalSheet/pro_attach_update'],function(firserBag){
				      ...
				      },
				      {
				    	  title:'历史工单查询',
				    	  click:function(e, tabData){
				    		  require(['js/workflow/proposalSheet/pro_historyWorkInfo'],function(historyWorkInfo){
