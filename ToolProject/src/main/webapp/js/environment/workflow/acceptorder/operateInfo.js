define(['Util','list','date','timer','select',
        'text!module/workflow/acceptorder/operateInfo.html',
        'style!css/workflow/acceptorder/operateInfo.css'],   
...
//		加载列表
	var yijiList = function(){
		...
		var config = {
			    ...
			    data:{
			        url:'/ngwf_he/front/sh/workflow!execute?uid=operate001'
			    }
			}
	...
	var yijiQuality = function(){
		...
		var config = {
			    ...
			    data:{
			        url:'/ngwf_he/front/sh/workflow!execute?uid=orderQuality001'
			    }
			}
		var list = new List(config);
		list.search({});
