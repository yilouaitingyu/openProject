define([ 'Util', 'process', 'indexLoad', 'hdb' ,'text!module/workflow/acceptorder/flowRecord.html','style!css/workflow/acceptorder/flowRecord.css'], function(Util, Process, IndexLoad, Hdb,Html_flowRecord) {
	var list;
	var $el;
	var _index;
	var _options;
