define(['Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/oneservicecomplain/consultationForm.html', 'style!css/workflow/oneservicecompain/consultationForm.css'],
function(Util, Timer, Validator, Select, SelectTree, Mydate, IndexLoad, DetailPanel, Hdb, Html_consultationForm) {
    var $el;
    var _index;
    var _options;
    var _result;
    var initialize = function(index, options) {
        $el = $(Html_consultationForm);
        _index = index;
        _options = options;
        this.pageInit();
        this.content = $el;
