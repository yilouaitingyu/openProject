define(['Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/oneservicecomplain/acceptorder.html', 'style!css/workflow/oneservicecompain/basicMessage.css'],
