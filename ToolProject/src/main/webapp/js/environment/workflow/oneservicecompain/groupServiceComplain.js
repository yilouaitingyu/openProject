define(['Util', 'timer', 'validator', 'select', 'selectTree', 'date', 'indexLoad', "detailPanel", "hdb", 'text!module/workflow/oneservicecomplain/groupServiceComplain.html', 'style!css/workflow/oneservicecompain/groupServiceComplain.css'],
